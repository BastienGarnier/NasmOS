...
_start:
	...
	call screen__update_cursor ; ptit update graphique, parce-que le cursor est n'importe où (aléatoire puis placé par QEMU)
	...
	mov ebx, 0x3FC00000
	push ebx
	call string__memcpy ; copie user_task1
...
msg db "Le kernel est charge !", 10, 0
...
pop ebp
ret
.msg db "Tache utilisateur en cours d'execution", 10, 0
